        ...
        <Card className="w-full bg-slate-900/80 backdrop-blur-xl border-cyan-500/20 shadow-2xl shadow-cyan-500/10">
          ...
          <form onSubmit={handleRegister}>
            <CardContent className="space-y-5">
              ...
              >
                <Label htmlFor="name" className="text-cyan-100">Nombre</Label>
                <div className="relative group">
                  <User className="absolute left-3 top-3 h-4 w-4 text-cyan-400/70 group-focus-within:text-cyan-400 transition-colors" />
                  <Input
                    id="name"
                    type="text"
